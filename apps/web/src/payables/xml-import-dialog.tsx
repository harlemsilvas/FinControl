  ...
  const importMutation = useMutation({
    mutationFn: async () => {
      ...
      const response = await httpClient.post<XmlImportResult>('/api/v1/xml-imports', {
        ...
        supplierPostalCode: parsed.supplier.postalCode ?? null,
        supplierStreet: parsed.supplier.street ?? null,
        supplierStreetNumber: parsed.supplier.streetNumber ?? null,
        supplierAddressComplement: parsed.supplier.addressComplement ?? null,
        supplierNeighborhood: parsed.supplier.neighborhood ?? null,
        supplierPhone: parsed.supplier.phone ?? null,
